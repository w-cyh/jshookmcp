...
export const referenceSidebarItems = [
  ...
  { text: 'APK Packer', link: '/en/reference/domains/apk-packer' },
  { text: 'Binary Instrument', link: '/en/reference/domains/binary-instrument' },
  { text: 'Binary Secrets', link: '/en/reference/domains/binary-secrets' },
  ...
  { text: 'Evidence', link: '/en/reference/domains/evidence' },
  ...
  { text: 'Shared State Board', link: '/en/reference/domains/shared-state-board' },
  { text: 'Skia Capture', link: '/en/reference/domains/skia-capture' },
